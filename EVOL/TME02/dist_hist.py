...
def plot_hist(fam_paralog_list,fam,plotName=None):
    x = [ int(cp) for cp in np.array(fam_paralog_list)[:,1] ]
    bins = list(set(x))
    width = 0.8
    bins.sort()
...
plot_hist(CP_paralog_list,"Salmonella enterica","CP.png")

NC_paralog_list = fam_paralog_statis(fam_silix_dict,genome="NC")
plot_hist(NC_paralog_list,"Escherichia coli","NC.png")

BX_paralog_list = fam_paralog_statis(fam_silix_dict,genome="BX")
plot_hist(BX_paralog_list,"Staphylococcus aureus","BX.png")
