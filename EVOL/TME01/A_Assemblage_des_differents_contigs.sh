...
# blastp
makeblastdb -in amino_acids_chromosome1.txt -input_type 'fasta' -out 'chrDB' -dbtype 'prot'
blastp -db 'chrDB' -query amino_acids_chromosome1.txt -out chr.blastn -outfmt '7'
